...
// GET Endpoint - Bütün məlumatlar və ya title ilə filtr
...
// POST Endpoint - Yeni məlumat əlavə edir
...
// DELETE Endpoint - ID ilə məlumat silir
app.delete("/data/:id", (req, res) => {
  ...
  if (index !== -1) {
    ...
    res.status(200).json({ message: "Məlumat silindi", removedItem });
  } else {
    res.status(404).json({ error: "Məlumat tapılmadı" });
  }
});
